...
class XLoveCam(Bot):
    ...
    def getPerformerId(self):
        ...
        r = requests.post('https://www.xlovecam.com/hu/performerAction/onlineList', headers=self.headers, data=data)
        if not r.ok:
            return None
        resp = r.json()
    ...
    def getStatus(self):
        ...
        r = requests.post('https://www.xlovecam.com/hu/performerAction/getPerformerRoom', headers=self.headers, data=data)
